...
// Particle JS Start
    ...
    function loginAuthentication(requestLink, authData){
        $.ajax({
            ...
            success : function(data) {
                if(data==='false'){
                    $('.notification').html('<div class="alert alert-danger"><strong>Woops!</strong> Invalid email or phone and password. Please try again with correct info.</div>')
                }else{
                    $('.notification').html('');
    ...
    $(document).ready(function () {
        $(document).on('submit','#user_login',function (e) {
            ...
            var requestLink= '<?php echo base_url('affiliate/authentication'); ?>';
            var authData={
        ...
        $(document).on('submit','#forgot_password',function (e) {
            ...
            var requestLink='<?php echo base_url('affiliate/forgot'); ?>';
            var resetEmail={
        ...
        $(document).on('submit','#reset_password',function (e) {
            ...
            var requestLink='<?php echo base_url('affiliate/reset'); ?>';
            var resetPassword={
                'reset_id': reset_id,
