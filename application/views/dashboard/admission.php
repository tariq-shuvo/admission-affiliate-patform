        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="affiliateName" name="affiliateName" value="" aria-describedby="affiliateName" placeholder="Affiliate phone no." autocomplete="off">
                </div>
                <div class="form-group">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="affiliateAmount" name="affiliateAmount" aria-describedby="affiliateAmount" placeholder="Affiliate amount" autocomplete="off">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="studentDiscount" name="studentDiscount" aria-describedby="studentDiscount" placeholder="Student discount" autocomplete="off">
                </div>
                <div class="form-group">
