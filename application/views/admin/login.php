                    ...
                    <form action="" method="post" id="user_login">
                        <div class="col-md-10 offset-md-1">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control custom_input" id="admin_username_or_email" placeholder="Username or email">
                            </div>
                        </div>
                        <div class="col-md-10 offset-md-1">
                            <div class="input-group mb-3">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    ...
                                    <div class="float-right">
                                        <a class="custom_font" href="<?php echo base_url('admin/forgot'); ?>">Forget password?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
